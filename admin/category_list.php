...
<div class="main-panel">
        <div class="content-wrapper">
          <div class="row">
		    <a href="addcategory.php" class="btn btn-primary mb-2 ml-2">New</a>
			<br>
...
<?php }?></td>
                                <td>
                                <a class="btn btn-danger p-2" href="category_delete.php?id=<?php echo $row['id']; ?>"><i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php } ?>
                        </tbody>
